...
@sdlc.vitechteam/sdlc-pipeline-helper/0.0.11 linux-x64 node-v14.18.0
...
_See code: [src/commands/check-publish.ts](https://github.com/vitech-team/sdlc-pipeline-helper/blob/v0.0.11/src/commands/check-publish.ts)_
...
_See code: [src/commands/junit-report-publish.ts](https://github.com/vitech-team/sdlc-pipeline-helper/blob/v0.0.11/src/commands/junit-report-publish.ts)_
...
_See code: [src/commands/sarif-publish.ts](https://github.com/vitech-team/sdlc-pipeline-helper/blob/v0.0.11/src/commands/sarif-publish.ts)_
<!-- commandsstop -->
